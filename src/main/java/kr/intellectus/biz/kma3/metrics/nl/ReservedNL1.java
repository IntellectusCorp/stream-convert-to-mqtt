...
public class ReservedNL1 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL1;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL1(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL1(final int represented) {
