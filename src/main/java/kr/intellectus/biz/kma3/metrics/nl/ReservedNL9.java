...
public class ReservedNL9 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL9;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL9(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL9(final int represented) {
