...
public class ReservedNL3 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL3;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL3(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL3(final int represented) {
