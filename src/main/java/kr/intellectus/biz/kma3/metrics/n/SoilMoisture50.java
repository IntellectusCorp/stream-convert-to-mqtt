...
public class SoilMoisture50 extends Measurement {

    private final static Metrics metric = Metrics.SOIL_MOISTURE50;
    public final static int OFFSET_BYTES = 2;
    
    private final static int BITS_OFFSET = 10;

    public SoilMoisture50(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public SoilMoisture50(final int represented) {
