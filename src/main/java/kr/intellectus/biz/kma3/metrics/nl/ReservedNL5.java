...
public class ReservedNL5 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL5;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL5(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL5(final int represented) {
