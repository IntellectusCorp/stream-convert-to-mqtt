...
public class WindSpeedInstantaneous150 extends Measurement {

    static final kr.intellectus.util.Logger logger = kr.intellectus.util.Loggers.getLogger(WindSpeedInstantaneous150.class);

    private final static Metrics METRIC = Metrics.WIND_SPEED_INSTANTANEOUS_150;
    private final static int BITS_OFFSET = 10;
    public final static int OFFSET_BYTES = 2;

    public WindSpeedInstantaneous150(byte[] bytes) {
        super(METRIC, bytes, BITS_OFFSET);
    }

    public WindSpeedInstantaneous150(int represented) {
