...
public class SoilMoisture10 extends Measurement {

    private final static Metrics metric = Metrics.SOIL_MOISTURE10;
    public final static int OFFSET_BYTES = 2;
    
    private final static int BITS_OFFSET = 10;

    public SoilMoisture10(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public SoilMoisture10(final int represented) {
