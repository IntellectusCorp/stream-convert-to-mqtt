...
public class ReservedNL7 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL7;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL7(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL7(final int represented) {
