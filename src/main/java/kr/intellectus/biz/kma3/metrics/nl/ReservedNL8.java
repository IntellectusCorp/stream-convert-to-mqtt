...
public class ReservedNL8 extends Measurement {

    private final static Metrics metric = Metrics.RESERVED_NL8;
    private final static int BITS_OFFSET = 16;
    public final static int OFFSET_BYTES = 2;

    public ReservedNL8(final byte[] rawBytes) {
        super(metric, rawBytes, BITS_OFFSET);
    }

    public ReservedNL8(final int represented) {
