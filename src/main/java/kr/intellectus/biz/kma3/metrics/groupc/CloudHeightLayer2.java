...
public class CloudHeightLayer2 extends Measurement {

    static final kr.intellectus.util.Logger logger = kr.intellectus.util.Loggers.getLogger(CloudHeightLayer2.class);

    private final static Metrics metric = Metrics.CLOUD_HEIGHT_LAYER2;
    private final static int BITS_OFFSET = 13;
    public final static int OFFSET_BYTES = 2;

    public CloudHeightLayer2(final byte[] bytes) {
        super(metric, bytes, BITS_OFFSET);
    }

    public CloudHeightLayer2(final int represented) {
